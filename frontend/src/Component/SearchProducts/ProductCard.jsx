...
function ProductCard({pId, image, title, price, offers, weight, deliveryBy}) {
    ...
    return (
            <div className='w-[100%] h-[23rem] cursor-pointer text-center overflow-hidden' style={{boxShadow: '-1px -1px 3px gray', borderRadius: '5px'}} onClick={() => navigate(`/show-product/${pId}`)}>
