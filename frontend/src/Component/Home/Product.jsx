...
function Product({pId, image, title, price, offers, weight, deliveryBy}) {
    ...
    return (
            <div className='w-[15rem] h-[20rem] cursor-pointer text-center m-2 overflow-hidden' style={{boxShadow: '-1px -1px 3px gray', borderRadius: '1rem'}} onClick={() => navigate('/show-product/:id')}>
