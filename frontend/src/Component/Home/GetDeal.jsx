...
function GetDeal() {
    return (
        <div className='bg-slate-100 relative mt-1'>
            ...
            <div className='h-[20rem] w-[100%] bg-black opacity-60 absolute top-0 flex items-center justify-center'>
            </div>
            <div className='absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex flex-col items-center justify-between'>
                <h1 className='text-yellow-500 text-xl md:text-4xl font-bold text-center'>Get Your Monthly Spices with us and save  upto ₹ 1000 on order upto ₹ 15000</h1>
