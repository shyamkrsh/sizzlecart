    ...
    const DrawerList = (
        <Box sx={{ width: 250 }} role="presentation" onClick={toggleDrawer(false)}>
            ...
            <ul className='pt-5 border-black'>
                ...
                <li style={{ fontSize: '1rem ', fontWeight: '400' }} className='px-3 py-2  hover:bg-cyan-50  text-slate-600'><Link to={"/"} className='flex items-center gap-4 px-3 '><MdOutlineBorderColor className='text-slate-600 text-2xl' /> My Orders</Link></li>
                ...
                <li style={{ fontSize: '1rem ', fontWeight: '400' }} className='px-3 py-2  hover:bg-cyan-50  text-slate-600'><Link to={"/"} className='flex items-center gap-4 px-3 '><FaRegBell className='text-slate-600 text-2xl font-semibold' /> My Notifications</Link></li>
                <li style={{ fontSize: '1rem ', fontWeight: '400' }} className='px-3 py-2  hover:bg-cyan-50  text-slate-600'><Link to={"/"} className='flex items-center gap-4 px-3 '><IoSettingsOutline className='text-slate-600 text-2xl' /> Settings</Link></li>
